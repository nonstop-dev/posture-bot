...
public static class MessageHelper
{
    ...
    private static readonly string _initialConfigurationFinished = "✅ <b>Всё готово!</b>\n" +
    ...
    {
        50 => "🥉 <b>50-е выпрямление!</b> Твой ранг повышен: теперь ты 🪵 <b>Палка!</b> Привычка начинает формироваться, держись прямо!",
        100 => "🥈 <b>100-е выпрямление!</b> Твой ранг повышен: 🐈 <b>Выпрямившийся котик!</b> Позвоночник шлет тебе воздушный поцелуй. Выпрямись!",
        250 => "🥇 <b>250-е выпрямление!</b> Твой ранг повышен: 🏛 <b>Античная колонна!</b> Осанка входит в железную привычку. Выпрями спину!",
        500 => "🦾 Привет, это Настя из команды создателей бота «Выпрями спину!». Ого-го, на твоем счету уже 500 ровных спин, и твой ранг — <b>Стальной хребет!</b> Скажу по секрету, я терпеть этого бота не могу, честно! Он заставляет меня выпрямлять спину! Однако моя спина говорит ему спасибо! И ты выпрями спину!",
        1000 => "⚡ Привет, это Андрей из команды создателей бота «Выпрями спину!». Твоя спина выровнялась уже 1000 раз, и ты теперь — <b>Титан осанки!</b> Вот это да! Продолжай! Кривая спина — это не круто :) поэтому: выпрями спину!",
        2000 => "🌅 <b>2 000-е выпрямление!</b> Поздравляем, ты достиг вершины эволюции осанки и получил ранг <b>Великая Равнина!</b> Та самая гора, которая полностью выпрямила спину. Мы гордимся тобой!",
        _ => null
    };

    public static string? GetLegendaryMilestoneMessage(int legendaryCount) => legendaryCount switch
    {
        1 => "🌟 <b>Первая легенда!</b> Тебе выпало легендарное напоминание (шанс всего 3%). Запомни этот момент и выпрямись!",
        10 => "✨ <b>Ты – мега легенда!</b> На твоём счету уже 10 пойманных легендарных напоминалок!",
        _ => null
    };
    ...
    public static string GetStatsMessage(Subscriber subscriber)
    {
        ...
        return $"📬 Выпрямлений: <b>{subscriber.TotalMessagesSent}</b>\n" +
               $"🌟 Поймано легендарок: <b>{subscriber.LegendaryCount} / 10</b>\n" +
               $"🎖 Ранг: <b>{rank}</b>\n\n" +
               $"Расправь плечи и держи планку! 💪";
    }

    public static string GetHelpMessage() =>
        "ℹ️ <b>«Выпрями спину, гора!»</b> — бот для твоей идеальной осанки.\n\n" +
        "Команды:\n" +
